...
// statechart.h - Header-only C++20 Statechart / Hierarchical State Machine
// (HSM) framework
//
...
//   - Protected: Enter(), Exit(), Switch(), Transition(), EnterState(),
// ExitState()
...
#define STATECHART(Name, _EventType, _ContextType)                            \
    class Name {                                                              \
       ...
       protected:                                                             \
         ...
         */                                                                   \
        static void Transition(Base* from, Base* to, _Context ctx) {          \
...
//   - Virtual: stay(), name(), Depth(), ParentState(), Enter(), Exit(),
// HandleEvent()
    ...
    class Name : public Parent {                                           \
       public:                                                             \
        ...
        int Depth() const override {                                       \
            static const int d = Parent::Depth() + 1;                      \
            return d;                                                      \
        }                                                                  \
                                                                           \
